...
## Download
Navigate to the `dist/` folder for the latest `.whl` file to download the latest version. Make sure you have the requiremenets needed in the `requires.txt`[MarketLevelSC.egg-info/requires.txt] file.
